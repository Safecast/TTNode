...
/*=========================================================================
  I2C ADDRESS/BITS
  -----------------------------------------------------------------------*/
#define MAX17201_I2C_ADDRESS                     (0x40)    // 1000000 (A0+A1=GND)
#define MAX17201_READ                            (0x01)
/*=========================================================================*/

/*=========================================================================
  CONFIG REGISTER (R/W)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_CONFIG                      (0x00)
/*---------------------------------------------------------------------*/
#define MAX17201_CONFIG_RESET                    (0x8000)  // Reset Bit

#define MAX17201_CONFIG_BVOLTAGERANGE_MASK       (0x2000)  // Bus Voltage Range Mask
#define MAX17201_CONFIG_BVOLTAGERANGE_16V        (0x0000)  // 0-16V Range
#define MAX17201_CONFIG_BVOLTAGERANGE_32V        (0x2000)  // 0-32V Range

#define MAX17201_CONFIG_GAIN_MASK                (0x1800)  // Gain Mask
#define MAX17201_CONFIG_GAIN_1_40MV              (0x0000)  // Gain 1, 40mV Range
#define MAX17201_CONFIG_GAIN_2_80MV              (0x0800)  // Gain 2, 80mV Range
#define MAX17201_CONFIG_GAIN_4_160MV             (0x1000)  // Gain 4, 160mV Range
#define MAX17201_CONFIG_GAIN_8_320MV             (0x1800)  // Gain 8, 320mV Range

#define MAX17201_CONFIG_BADCRES_MASK             (0x0780)  // Bus ADC Resolution Mask
#define MAX17201_CONFIG_BADCRES_9BIT             (0x0080)  // 9-bit bus res = 0..511
#define MAX17201_CONFIG_BADCRES_10BIT            (0x0100)  // 10-bit bus res = 0..1023
#define MAX17201_CONFIG_BADCRES_11BIT            (0x0200)  // 11-bit bus res = 0..2047
#define MAX17201_CONFIG_BADCRES_12BIT            (0x0400)  // 12-bit bus res = 0..4097

#define MAX17201_CONFIG_SADCRES_MASK             (0x0078)  // Shunt ADC Resolution and Averaging Mask
#define MAX17201_CONFIG_SADCRES_9BIT_1S_84US     (0x0000)  // 1 x 9-bit shunt sample
#define MAX17201_CONFIG_SADCRES_10BIT_1S_148US   (0x0008)  // 1 x 10-bit shunt sample
#define MAX17201_CONFIG_SADCRES_11BIT_1S_276US   (0x0010)  // 1 x 11-bit shunt sample
#define MAX17201_CONFIG_SADCRES_12BIT_1S_532US   (0x0018)  // 1 x 12-bit shunt sample
#define MAX17201_CONFIG_SADCRES_12BIT_2S_1060US  (0x0048)  // 2 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_4S_2130US  (0x0050)  // 4 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_8S_4260US  (0x0058)  // 8 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_16S_8510US (0x0060)  // 16 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_32S_17MS   (0x0068)  // 32 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_64S_34MS   (0x0070)  // 64 x 12-bit shunt samples averaged together
#define MAX17201_CONFIG_SADCRES_12BIT_128S_69MS  (0x0078)  // 128 x 12-bit shunt samples averaged together

#define MAX17201_CONFIG_MODE_MASK                (0x0007)  // Operating Mode Mask
#define MAX17201_CONFIG_MODE_POWERDOWN           (0x0000)
#define MAX17201_CONFIG_MODE_SVOLT_TRIGGERED     (0x0001)
#define MAX17201_CONFIG_MODE_BVOLT_TRIGGERED     (0x0002)
#define MAX17201_CONFIG_MODE_SANDBVOLT_TRIGGERED (0x0003)
#define MAX17201_CONFIG_MODE_ADCOFF              (0x0004)
#define MAX17201_CONFIG_MODE_SVOLT_CONTINUOUS    (0x0005)
#define MAX17201_CONFIG_MODE_BVOLT_CONTINUOUS    (0x0006)
#define MAX17201_CONFIG_MODE_SANDBVOLT_CONTINUOUS (0x0007)
/*=========================================================================*/

/*=========================================================================
  SHUNT VOLTAGE REGISTER (R)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_SHUNTVOLTAGE                (0x01)
/*=========================================================================*/

/*=========================================================================
  BUS VOLTAGE REGISTER (R)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_BUSVOLTAGE                  (0x02)
/*=========================================================================*/

/*=========================================================================
  POWER REGISTER (R)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_POWER                       (0x03)
/*=========================================================================*/

/*=========================================================================
  CURRENT REGISTER (R)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_CURRENT                     (0x04)
/*=========================================================================*/

/*=========================================================================
  CALIBRATION REGISTER (R/W)
  -----------------------------------------------------------------------*/
#define MAX17201_REG_CALIBRATION                 (0x05)
/*=========================================================================*/
...
// Configures to MAX17201 to be able to measure up to 32V and 2A
...
void ina219_setCalibration_32V_2A(void)
{
    ...
    ina219_cfgValue = MAX17201_CONFIG_BVOLTAGERANGE_32V |
        MAX17201_CONFIG_GAIN_8_320MV |
        MAX17201_CONFIG_BADCRES_12BIT |
        MAX17201_CONFIG_SADCRES_12BIT_1S_532US;

#if (CONFIG_MODE==CONFIG_MODE_TRIGGERED)
    ina219_cfgValue |= MAX17201_CONFIG_MODE_SANDBVOLT_TRIGGERED;
#else
    ina219_cfgValue |= MAX17201_CONFIG_MODE_SANDBVOLT_CONTINUOUS;
#endif

}

// Configures to MAX17201 to be able to measure up to 32V and 1A
...
void ina219_setCalibration_16V_400mA(void) {
    ...
    // Set config to take into account the settings above
    ina219_cfgValue = MAX17201_CONFIG_BVOLTAGERANGE_16V |
        MAX17201_CONFIG_GAIN_1_40MV |
        MAX17201_CONFIG_BADCRES_12BIT |
        MAX17201_CONFIG_SADCRES_12BIT_1S_532US;
...
#define TWI_CURRENT_FUDGE 3.0
    ...
    if (num_samples < PWR_SAMPLE_BINS) {
        ...
        // Compute the SOC value based on experimental data.
        ...
        if (debug(DBG_SENSOR))
            DEBUG_PRINTF("MAX17201 reports %.3fmA %.3fV %.3fbV %.3fsV %.3f%%\n",
...
void s_max01_measure(void *s) {
    ...
    io.buf_config[0] = MAX17201_REG_CONFIG;
    io.buf_config[1] = 0xff & (cfg >> 8);
    io.buf_config[2] = 0xff & cfg;
    uint16_t cal = ina219_calValue;
    io.buf_calibration[0] = MAX17201_REG_CALIBRATION;
    io.buf_calibration[1] = 0xff & (cal >> 8);
    io.buf_calibration[2] = 0xff & cal;
    io.buf_current_cmd[0] = MAX17201_REG_CURRENT;
    io.buf_shunt_voltage_cmd[0] = MAX17201_REG_SHUNTVOLTAGE;
    io.buf_bus_voltage_cmd[0] = MAX17201_REG_BUSVOLTAGE;
    static app_twi_transfer_t const transfers[] = {
        APP_TWI_WRITE(MAX17201_I2C_ADDRESS, &io.buf_config[0], sizeof(io.buf_config), 0),
        APP_TWI_WRITE(MAX17201_I2C_ADDRESS, &io.buf_calibration[0], sizeof(io.buf_calibration), 0),
        APP_TWI_WRITE(MAX17201_I2C_ADDRESS, &io.buf_current_cmd[0], sizeof(io.buf_current_cmd), APP_TWI_NO_STOP),
        APP_TWI_READ(MAX17201_I2C_ADDRESS, &io.buf_current_val[0], sizeof(io.buf_current_val), 0),
        APP_TWI_WRITE(MAX17201_I2C_ADDRESS, &io.buf_shunt_voltage_cmd[0], sizeof(io.buf_shunt_voltage_cmd), APP_TWI_NO_STOP),
        APP_TWI_READ(MAX17201_I2C_ADDRESS, &io.buf_shunt_voltage_val[0], sizeof(io.buf_shunt_voltage_val), 0),
        APP_TWI_WRITE(MAX17201_I2C_ADDRESS, &io.buf_bus_voltage_cmd[0], sizeof(io.buf_bus_voltage_cmd), APP_TWI_NO_STOP),
        APP_TWI_READ(MAX17201_I2C_ADDRESS, &io.buf_bus_voltage_val[0], sizeof(io.buf_bus_voltage_val), 0)
    };
