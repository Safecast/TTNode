...
#PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS
# This is breadboard using UGPS and INA219 and 1 tube
PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DOCSENSE -DBATIOT -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DG1=LND7318C -DTWIX -DTWIBME280 -DTWIBME280AIR -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
#PERIPHERAL_DEFS := -DOCSENSE -DBATIOT -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DTWIX -DTWIBME280 -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DUGPS -DTWIBME280AIR
DEBUG_DEFS := -DAIR_COUNTS -DNOMOTION -DBTKEEPALIVE -DCOMMS_FORCE_NONBUFFERED
#PERIPHERAL_DEFS := -DPOWERDEBUG
#DEBUG_DEFS := 
endif
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DGEIGERX -DG0=LND7318U -DG1=LND7128EC -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DLABEL=ray-homecast -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DPMSX=IOUART -DPMS5003 -DLORA -DHWFC=false -DAIR_COUNTS
