...
PERIPHERAL_DEFS := -DGEIGER -DBGEIGIE -DTWIX -DTWIMAX17043 -DTWIHIH6130 -DTWIUBLOXM8 -DLORA
...
# This is using UGPS and INA219
PERIPHERAL_DEFS := -DPOWERSENSE -DGEIGER -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS -DAIR_COUNTS
# This is using UGPS and MAX17201
#PERIPHERAL_DEFS := -DPOWERSENSE -DGEIGER -DTWIX -DTWIBME280 -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS -DAIR_COUNTS
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DPOWERSENSE -DGEIGER -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS -DAIR_COUNTS
endif
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS :=  -DPMSX=IOUART -DPMS5003 -DLORA -DHWFC=false -DAIR_COUNTS
endif
