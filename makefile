...
PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DPOWERSENSE -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS -DAIR_COUNTS
