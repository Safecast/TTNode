...
DEBUG_DEFS := -DAIR_COUNTS -DBTKEEPALIVE -DSSDKEEPALIVE -DBURN -DBURNFONA -DBURNCOMMS -DOPCCORRUPTIONDEBUG
...
DEBUG_DEFS := -DAIR_COUNTS -DBTKEEPALIVE -DBURN
## For power testing
#PERIPHERAL_DEFS := -DPOWERDEBUG
#PERIPHERAL_DEFS := -DPOWERDEBUG -DPOWERDEBUG_OUTPUTS_ON
## This is for Musti's testing
DEBUG_DEFS := -DAIR_COUNTS -DBTKEEPALIVE -DSSDKEEPALIVE -DBURN -DBURNCOMMS -DBURNFONA
#REMOVE THIS WHEN COMFORTABLE WITH DISPLAY
#DEBUG_DEFS := -DAIR_COUNTS -DBTKEEPALIVE -DBURN -DBURNCOMMS -DBURNFONA
##PERIPHERAL_DEFS := -DOCSENSE -DUSX -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DG1=LND7318C -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIBME1 -DTWIBME0AIR -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
