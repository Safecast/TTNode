...
#PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DPOWERSENSE -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS
# This is breadboard using UGPS and INA219 and 1 tube
PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DPOWERSENSE -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
# This is production using UGPS and MAX17201 and dual-pancakes
#PERIPHERAL_DEFS := -DPOWERSENSE -DGEIGERX -DG0=LND7318U -DG1=LND7318C -DTWIX -DTWIBME280 -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
