...
PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DUSX -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS -DTESTDEVICE
