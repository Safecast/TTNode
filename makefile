...
#PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DTWIX -DTWIBME280X -DTWIBME0 -DTWIBME1 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS -DTESTDEVICE
# This is breadboard using UGPS and INA219 and 1 tube
PERIPHERAL_DEFS := -DLABEL=ray-breadboard -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIBME1 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS -DTESTDEVICE
DEBUG_DEFS := -DBURN
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DOCSENSE -DBOARDSV1 -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DG1=LND7318C -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIBME1 -DTWIBME0AIR -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
DFU := NODFU
DEBUG_DEFS := -DBURN -DBURNFAST
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DGEIGERX -DG0=LND7318U -DG1=LND7128EC -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIINA219 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DFONAGPS
...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DLABEL=ray-homecast -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DPMSX=IOUART -DPMS5003 -DLORA -DHWFC=false -DAIR_COUNTS -DTESTDEVICE
