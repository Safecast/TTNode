...
NRF_DEFS := -DNRF52832 -DNRF_SD_BLE_API_VERSION=3
CPU_DEFS := -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -mabi=aapcs
PERIPHERAL_DEFS := -DSSD -DOCSENSE -DUSX -DUSLORA=USab -DUSFONA=USAb -DUSPMS=USaB -DUSGPS=USAB -DGEIGERX -DG0=LND7318U -DG1=LND7318C -DTWIX  -DTWIBME280X -DTWIBME0 -DTWIBME1 -DTWIBME0AIR -DTWIMAX17201 -DMOTIONX -DTWILIS3DH -DAIRX -DPMSX=IOUART -DPMS5003 -DSPIX -DSPIOPC -DLORA -DCELLX -DFONA -DUGPS
## For power testing
#PERIPHERAL_DEFS := -DPOWERDEBUG
